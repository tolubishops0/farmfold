...
import { productList } from "../../../Style/CommonStyle";
import { navstyles } from "../NavBar/NavBar";
import {
  textCapitalize,
  numberWithCommas,
...
import AjOpenProductDetail from "../../AjOpenProductDetails/AjOpenProductDetails";
import { AjRating } from "../../../Components/AjRating";
import AjDetailData from "../../AjDetailData/AjDetailData";
import { styles } from "../../AjTradingActiveAdsCard/AjTradingActiveCardStyles";
...
const InputListing = ({}) => {
  ...
  const handleViewMore = (index) => {
    setData(inputActiveAdsList?.result[index]);
    setOpenModal(true);
  };
  ...
  return (
    <Box>
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        <Typography sx={{ ...productList.valueProposition }}>
          Browse through Inputs
        </Typography>
